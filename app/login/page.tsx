  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
      ...
      <div className="w-full max-w-sm rounded-3xl border border-border bg-surface p-8 shadow-sm">
        ...
        <p className="mt-2 text-center text-sm text-muted-foreground">Log in to your workspace</p>
        ...
        <p className="mt-8 text-center text-sm text-muted-foreground">
          ...
          <Link href="/signup" className="font-semibold text-foreground hover:text-brand">
            Sign up
          </Link>
        </p>
      </div>
